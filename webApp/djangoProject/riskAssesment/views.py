...
def symptoms_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if instance.caugh == "Yes" or instance.caugh == "Yes" or instance.shortness_of_breath == "Yes" or instance.fever == "Yes" or instance.body_pain == "Yes" or instance.sore_throat == "Yes"  or instance.loss_of_taste == "Yes" or instance.loss_of_smell == "Yes"  :
